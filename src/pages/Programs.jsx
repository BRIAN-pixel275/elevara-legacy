...
function Programs() {
  return (
    <>
      <SEO
        title="Women Empowerment Programs | Elevara Legacy"
        description="Explore Elevara Legacy programs in financial literacy, leadership development, mentorship and entrepreneurship designed to equip women with practical skills for lasting success."
        path="/programs"
      />
        ...
        <div className="program-showcase-container">
          ...
          <div className="showcase-item">
            ...
            <div className="showcase-content">
              ...
              <p>
                Empower yourself to become a changemaker in your
      ...
      <section className="programs-cta">
        <div className="programs-cta-container">
          ...
          <div className="programs-cta-buttons">
            <a
              href="/contact"
              className="programs-primary-btn"
            >
              Join Our Programs
            </a>
            ...
            <a
              href="/community"
              className="programs-secondary-btn"
            >
