...
function About() {
  return (
    <>
      <SEO
        title="About Elevara Legacy | Our Mission & Vision"
        description="Learn about Elevara Legacy, our mission, vision, values and commitment to empowering women through leadership, financial education and personal development."
        path="/about"
      />
