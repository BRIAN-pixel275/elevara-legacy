...
function Community() {
  return (
    <>
      <SEO
        title="Elevara Legacy Community | Connect & Grow"
        description="Join the Elevara Legacy community of women building meaningful connections, developing their skills, accessing mentorship and creating lasting impact together."
        path="/community"
      />
